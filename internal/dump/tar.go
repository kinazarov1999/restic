...
func (d *SequentialDumper) dumpTar(ctx context.Context, ch <-chan *restic.Node) (err error) {
...
func (d *SequentialDumper) dumpNodeTar(ctx context.Context, node *restic.Node, w *tar.Writer) error {
