...
func printFromTree(ctx context.Context, tree *restic.Tree, repo restic.BlobLoader, prefix string, pathComponents []string, dumper dump.Dumper, canWriteArchiveFunc func() error) error {
